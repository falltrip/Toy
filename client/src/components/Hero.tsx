    ...
    >
        ...
        <div className="h-full w-full flex items-center justify-center">
          ...
          >
            ...
            <motion.div
              ...
              style={{
                background:
                  "radial-gradient(circle, rgba(0,255,255,0.2) 0%, rgba(255,0,255,0.1) 70%, transparent 100%)",
              }}
              animate={{
                scale: [1, 1.05, 1],
                opacity: [0.4, 0.7, 0.4],
            ...
            <div className="relative h-[300px] w-[300px] md:h-[450px] md:w-[450px] lg:h-[550px] lg:w-[550px] bg-cyber-black rounded-full border border-neon-cyan/30 overflow-hidden flex items-center justify-center perspective">
              ...
              >
                ...
                >
                  Turn visions into reality, one creation at a time. Unleash
                  your imagination in this boundless space.
                </motion.p>
              </motion.div>
            </div>
      ...
      <div className="absolute bottom-16 left-0 right-0 z-20 flex justify-center">
        ...
        >
          ...
          >
            <span className="relative z-10 font-orbitron text-white group-hover:text-black transition-colors duration-300">
              ENTER SPACE
            </span>
            <motion.span
